			...
			<div class="row">
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-new rounded-0">
						...
						<a href="<?= base_url(); ?>repair_system/admin/admin_list?status=1"
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-doing rounded-0">
						...
						<a href="<?= base_url(); ?>repair_system/admin/admin_list?status=2"
							class="small-box-footer rounded-0">
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-finish rounded-0">
						...
						<a href="<?= base_url(); ?>repair_system/admin/admin_list?status=3"
							class="small-box-footer rounded-0">
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-cancel rounded-0">
						...
						<a href="<?= base_url(); ?>repair_system/admin/admin_list?status=4"
							class="small-box-footer rounded-0">
