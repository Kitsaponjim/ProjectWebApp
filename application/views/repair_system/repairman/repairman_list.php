...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="box">
			<div class="box-header">
				...
				<br>
				<a href="<?= site_url('repair_system/repairman/repairman_list'); ?>?status=1" class="btn btn-primary">
					งานใหม่
					<span class="badge">
						<?= $count_case_new; ?>
					</span></a>
				<a href="<?= site_url('repair_system/repairman/repairman_list'); ?>?status=2" class="btn btn-warning">
					กำลังดำเนินงาน <span class="badge">
						<?= $count_case_wait; ?>
					</span></a>
				<a href="<?= site_url('repair_system/repairman/repairman_list'); ?>?status=3" class="btn btn-success">
					เสร็จสิ้น
					<span class="badge">
						<?= $count_case_finish; ?>
					</span></a>
				<a href="<?= site_url('repair_system/repairman/repairman_list'); ?>?status=4" class="btn btn-danger">
					ยกเลิก
					<span class="badge">
						<?= $count_case_cancel; ?>
					</span></a>
	...
	<script>
		...
		function onEdit(rp_id) {
			window.location = "<?= base_url(); ?>repair_system/repairman/manage_data/" + rp_id;
		}
