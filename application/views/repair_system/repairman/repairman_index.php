			...
			<div class="row">
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-new rounded-0">
						...
						<a href="<?= base_url(); ?>repair_system/repairman/repairman_list?status=1"
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-doing rounded-0">
						...
						<a href="<?= base_url(); ?>repair_system/repairman/repairman_list?status=2"
							class="small-box-footer rounded-0">
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-finish rounded-0">
						...
						<a href="<?= base_url(); ?>repair_system/repairman/repairman_list?status=3"
							class="small-box-footer rounded-0">
				...
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-cancel rounded-0">
						...
						<a href="<?= base_url(); ?>repair_system/repairman/repairman_list?status=4"
							class="small-box-footer rounded-0">
			...
			<div class="box-body">
				<div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
					<div class="row">
						...
						<div class="col-sm-6">
							...
							<table class="table table-bordered table-striped" role="grid"
								...
								<tbody>
									...
									<?php									
									$sql = "SELECT rp_type.rp_name_type, COUNT(rp_case.rp_case_type) AS count_type FROM rp_type JOIN rp_case 
									ON rp_name_type = rp_case_type GROUP BY rp_name_type";
						...
						<p style="font-size: 20px; background-color: #f2f2f2; padding: 10px;"><i class="fa fa-pencil"></i> ข้อมูลผู้แจ้ง</p>
